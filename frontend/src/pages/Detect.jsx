...
// Default diarahkan ke port 8003 agar tidak bentrok dengan service lain.
const DETECT_API_URL = import.meta.env.VITE_DETECT_API_URL || 'http://localhost:8003/detect'
